...
public class QuickSettingTileService extends TileService {
    public static final String ACTION_UPDATE_TITLE = "com.zii.sdk.helper.ACTION.UPDATE_TITLE";
    ...
    public void onTileAdded() {
        ...
        sendBroadcast(new Intent(GetTopActivity.ACTION_STATE_CHANGED));
    }
    ...
    public void onClick() {
        if (WatchingAccessibilityService.getInstance() == null || !Settings.canDrawOverlays(this)) {
            Intent intent = new Intent(this, GetTopActivity.class);
            intent.putExtra(GetTopActivity.EXTRA_FROM_QS_TILE, true);
