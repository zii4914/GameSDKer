package com.zii.sdk.helper.topactivity;
...
import com.zii.sdk.helper.R;
import com.zii.sdk.helper.base.BaseActivity;

public class GetTopActivity extends BaseActivity implements OnCheckedChangeListener {
    public static final String EXTRA_FROM_QS_TILE = "from_qs_tile";
    public static final String ACTION_STATE_CHANGED = "com.zii.sdk.helper.ACTION_STATE_CHANGED";
        ...
        if (isChecked && buttonView == mWindowSwitch && getResources().getBoolean(R.bool.use_accessibility_service)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1 && !Settings.canDrawOverlays(this)) {
                new AlertDialog.Builder(this)
                        ...
                        .setNegativeButton(android.R.string.cancel
                                , new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        SPHelper.setIsShowWindow(GetTopActivity.this, false);
                                        refreshWindowSwitch();
                                    }
                                })
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.dialog_enable_accessibility_positive_btn, (dialog, which) -> {
                            SPHelper.setIsShowWindow(GetTopActivity.this, true);
