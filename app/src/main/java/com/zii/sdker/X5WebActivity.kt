...
import com.zii.sdker.databinding.ActivityX5webBinding

class X5WebActivity : BaseActivity() {

    private lateinit var binding: ActivityX5webBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityX5webBinding.inflate(layoutInflater)
    ...
    private fun chromeClient(): WebChromeClient {
        return object : WebChromeClient() {
            ...
            override fun onShowFileChooser(
                ...
                this@X5WebActivity.uploadFiles = filePathCallback
